...
public class MyServerSelector100MBTransfert implements Runnable  {
    ...
    private int port;
    public MyServerSelector100MBTransfert(int port) {
        this.port = port;
    }
    ...
    public void run() {
        ...
        try {
            ...
            serverSocketChannel.socket().bind(new InetSocketAddress("localhost", port)); // server open
