...
public class Server2GB {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocketChannel serverSocketChannel = ServerSocketChannel.open()) {
            ...
            System.out.println("All "+WORKER_COUNT+" are connected, starting the 2G file distribution...");
            ...
            try(FileChannel fileChannel = FileChannel.open(Paths.get(randomDataTextFilePath2G.getPath()), StandardOpenOption.READ)){
